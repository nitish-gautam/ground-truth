...
echo "  📖 Backend API Docs:          ${BLUE}http://localhost:8002/docs${NC}"
...
echo ""
echo "  LiDAR Analysis:      ${BLUE}http://localhost:8002/api/v1/lidar${NC}"
echo "  Hyperspectral:       ${BLUE}http://localhost:8002/api/v1/progress/hyperspectral${NC}"
echo "  BIM Models:          ${BLUE}http://localhost:8002/api/v1/bim${NC}"
echo "  Progress Tracking:   ${BLUE}http://localhost:8002/api/v1/progress${NC}"
echo ""
...
echo "  ${YELLOW}curl -X POST http://localhost:8002/api/v1/lidar/elevation/point \\${NC}"
