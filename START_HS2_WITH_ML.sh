...
wait_for_service "Backend API" "http://localhost:8002/health"
...
echo "  Neo4j Browser:     http://localhost:7474  (neo4j / hs2_graph_2024)"
echo "  Flower (Celery):   http://localhost:5555"
echo ""
echo "🤖 ML Hyperspectral Endpoint:"
echo "  POST http://localhost:8002/api/v1/progress/hyperspectral/analyze-material"
echo ""
echo "📝 Test ML Models:"
echo ""
echo "  # Test with concrete sample:"
echo "  curl -X POST \"http://localhost:8002/api/v1/progress/hyperspectral/analyze-material\" \\"
