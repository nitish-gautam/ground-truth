...
echo -e "${GREEN}Backend API:${NC}            http://localhost:8007"
echo -e "${GREEN}API Documentation:${NC}      http://localhost:8007/docs"
echo -e "${GREEN}API Health Check:${NC}       http://localhost:8007/health"
echo -e "${GREEN}MinIO Console:${NC}          http://localhost:9011"
echo -e "${GREEN}Flower (Celery):${NC}        http://localhost:5555"
echo -e "${GREEN}TileServer:${NC}             http://localhost:8081"
echo ""
